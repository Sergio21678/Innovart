...
namespace InnovArt_Backend_Dotnet.Controllers // Asegúrate de que el namespace coincida con tu carpeta
{
    [ApiController]
    ...
    public class UsersController : ControllerBase
    {
        ...
        // Antes tenía [Authorize(Roles = "admin")], ahora es público.
        [HttpGet]
        [AllowAnonymous] 
        ...
        [HttpGet("{id}")]
        [AllowAnonymous] // También explícito para ver perfiles públicos
